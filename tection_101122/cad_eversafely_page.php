<?php
    ...
    <title>Contatos EverSafely</title>
</head>
<body>
<div class='container' id='container'>";
        ...
        while ($registro = mysqli_fetch_array($resultado)){
            ...
            echo "<td>". $Telefone . "</td>";
            echo "<td>". $Mensagem . "</td>";
            echo "<td><a href='crud_eversafely.php?acao=deletar&id=$id'>Deletar</a>
            <a href='crud_eversafely.php?acao=montar&id=$id'>Atualizar</a>
            ";
         ...
         echo "<br>";
         echo "<button type='submit' name='action' formaction='crud_eversafely.php?acao=preencher'>Cadastrar Contato</button>
